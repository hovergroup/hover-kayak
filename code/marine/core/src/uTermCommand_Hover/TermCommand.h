...
protected:
    ...
    std::map<std::string, std::vector<std::string> > m_var_name;
    std::map<std::string, std::vector<std::string> > m_var_type;
    std::map<std::string, std::vector<std::string> > m_var_val;
